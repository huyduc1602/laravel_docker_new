...
class UserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'lastNameKana'            => [
                'nullable',
                'max:' . Constant::VALIDATION_RULE['maxLength32'],
                'regex:' . Constant::VALIDATION_RULE['fullwidthKatakana']
            ],
            ...
            'jobType'                 => [
                ...
                Rule::exists('s_code', 'code')
                    ->where('category', CodeMaster::CATEGORY_D1011)
    ...
    public function messages(): array
    {
        return [
            ...
            'lastNameKana.max'                      => __('messages.VMSG.00016'),
            'lastNameKana.regex'                    => __('messages.VMSG.00107'),
            'firstName.required'                    => __('messages.VMSG.00001'),
            'firstName.max'                         => __('messages.VMSG.00016'),
            'firstNameKana.max'                     => __('messages.VMSG.00016'),
            'firstNameKana.regex'                   => __('messages.VMSG.00107'),
            ...
            'oldPassword.match_old_password'        => __('messages.AMSG.00001'),
            ...
            'jobType.exists'                        => __('messages.VMSG.00068'),
    ...
    public function attributes(): array
    {
        return [
            ...
            'lastNameKana'            => __('common.attributes.lastNameKana'),
            'firstName'               => __('common.attributes.firstName'),
            'firstNameKana'           => __('common.attributes.firstNameKana'),
            ...
            'jobType'                 => __('common.attributes.jobType'),
